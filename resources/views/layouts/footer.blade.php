        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-7">
                <div class="footer__about">
                    ...
                    <p>proud to be a reliable website, secure customer information. User-oriented product with 100% accuracy</p>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="footer__copyright__text">
                    <p>Copyright &copy; <script>document.write(new Date().getFullYear());</script> Website Shoes Store | Developed <i class="fa fa-heart" aria-hidden="true"></i> by Manh Nhat</a></p>
                </div>
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </div>
        </div>
